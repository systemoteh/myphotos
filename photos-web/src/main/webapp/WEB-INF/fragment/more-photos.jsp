            ...
            <figcaption>
                <p class="author">
                    <c:choose>
                        ...
                        <c:otherwise>
                            <a href="/${photo.profile.uid}" class="img"><img src="${photo.profile.avatarUrl}"
                                                                             alt="${photo.profile.fullName}"/></a>
                ...
                <p class="stat">
                    ...
                    <span><i class="fa fa-eye" aria-hidden="true"></i> ${photo.views} <span
                            class="txt">Views</span> |</span>

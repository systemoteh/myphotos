...
<div id="main">
    <section>
        <header class="major">
            <h1>Welcome, to Photos.ru</h1>
        </header>
        <div class="row">
            <div class="${'8u 12u$(xsmall)'}">
                <p>service, which allow you to share high-resolution photos for <a
                        href="https://creativecommons.org/publicdomain/zero/1.0/" target="_blank">free</a></p>
            </div>
